...
export const routes: Routes = [
  { path: '', component: LoginComponent },
  {
    ...
    children: [
      ...
      { path: 'support/create', loadComponent: () => import('./pages/ticket-create/ticket-create.component').then((m) => m.TicketCreateComponent) },
      { path: 'support/ticket-detail', loadComponent: () => import('./pages/ticket-detail/ticket-detail.component').then((m) => m.TicketDetailComponent) },
